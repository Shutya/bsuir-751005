...
function extractNameFromTemplate(value) {
    ...
    return helloRegex.exec(value)[1];
}
...
function getCardId(value) {
    ...
    var suitId = suits.indexOf(value.slice(-1));
    var numeralId = numerals.indexOf(value.slice(0, -1));
    return suitId * numerals.length + numeralId;
