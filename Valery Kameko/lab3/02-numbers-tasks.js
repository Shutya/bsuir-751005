...
function roundToPowerOfTen(num, pow) {
    var roundNumber = Math.pow(10, pow);
    return roundNumber * Math.round(num / roundNumber);
}
 ...
 */
function isPrime(n) {
    var checkNumbers = Array(Math.trunc(Math.sqrt(n))).fill()
        .map((e, i) => i + 1);
    return checkNumbers.every(e => n % e != 0 || e == 1);
}
