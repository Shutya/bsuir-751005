...
function extractNameFromTemplate(value) {
    var words = value.slice(0, value.length - 1).split(" ");
...
function getCardId(value) {
    ...
    let numValue = nums.indexOf(value.charAt(0));
    let learValue = lears.indexOf(value.charAt(value.length - 1));

    return numValue + learValue * 13;
}
