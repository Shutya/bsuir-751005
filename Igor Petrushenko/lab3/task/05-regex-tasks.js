...
function getRegexForIPv4() {
   var reg = /^([0-2]?([0-9]){1,2}\.){3}[0-2]?([0-9]){1,2}$/
   return reg;
}
...
function getRegexForSSN() {
   var reg = /^([1-9]|(0(?!0(?=0))))[0-9][0-9]-([1-9]|(0(?!0)))[0-9]-([1-9]|(0(?!0(?=0(?=0)))))[0-9][0-9][0-9]$/
   return reg;
}
...
function getPasswordValidator(minLength) {
   var reg = new RegExp('^[0-9a-zA-Z]{' + minLength + ',}(?<=[0-9a-zA-Z]*[a-z][0-9a-zA-Z]*)(?<=[0-9a-zA-Z]*[A-Z][0-9a-zA-Z]*)(?<=[0-9a-zA-Z]*[0-9][0-9a-zA-Z]*)$');
   return reg;
}
