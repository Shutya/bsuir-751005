 ...
 * @return {RegExp}
 */
function getRegexForGuid() { //64
   return /{[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-9dA-Fa-f]{4}-[0-9dA-Fa-f]{4}-[0-9A-Fa-f]{12}}/
}
 ...
 *
 */
function getRegexForPitSpot() { //65
   return /^(pi|s|r).+$/;
}
