 ...
 *   '',  'bb'  => 'bb'
 */
function concatenateStrings(value1, value2) { //1
 ...
 *   ''      => 0
 */
function getStringLength(value) {	//2
   	return value.length;
}
 ...
 */
function getStringFromTemplate(firstName, lastName) {  //3
 ...
 */
function extractNameFromTemplate(value) {	//4
 ...
 */
function removeLeadingAndTrailingWhitespaces(value) {	//6
    return value.trim();
}
 ...
 *   'cat', 3 => 'catcatcat'
 */
function repeatString(value, count) {		//7
 ...
 *   'ABABAB','BA' => 'ABAB'
 */
function removeFirstOccurrences(str, value) {	//8
 ...
 */
function convertToUpperCase(str) {	//10
 ...
 *
 */
function getRectangleString(width, height) {	//12
