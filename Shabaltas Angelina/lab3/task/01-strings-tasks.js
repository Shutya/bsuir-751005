...
function encodeToRot13(str) { 
    return str.replace(/[a-zA-Z]/g, c => String.fromCharCode((c.charCodeAt(0) + 13)  > (c <= 'Z' ? 'Z'.charCodeAt(0) : 'z'.charCodeAt(0)) ? c.charCodeAt(0) - 13 : c.charCodeAt(0) + 13));
}
...
function getCardId(value) {
	let TYPES = { '♣': 0, '♦': 1, '♥': 2, '♠': 3 };
    return TYPES[value[value.length - 1]] * 13 + getNum(value.substr(0, value.length - 1));
}
