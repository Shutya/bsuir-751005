...
/*< count Re++ve the first occurrence of string inside another string
 * 
 * @param {string} str
 * @param {string} value
 * @return {string}
...
function encodeToRot13(str) {
    ...
    const subStr = 'NOPQRSTUVWXYZABCDEFGHIJKLMnopqrstuvwxyzabcdefghijklm';

    var encoded = "";
    var index;
    for(var ch of str)
        encoded += (index = alphabet.indexOf(ch)) == -1? ch : subStr[index];
